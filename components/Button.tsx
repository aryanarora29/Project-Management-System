...
//     className={`flexCenter gap-3 px-4 py-3 
//     ${textColor ? textColor : 'text-white'} 
//     ${submitting ? 'bg-black/50' : bgColor ? bgColor : 'bg-green-500'} rounded-xl text-sm font-medium max-md:w-full`}
//     onClick={handleClick}
//>
...
<button
  ...
  ${submitting ? 'bg-black/50' : bgColor ? bgColor : 'bg-primary-purple'} rounded-xl text-sm font-medium max-md:w-full`}
  onClick={handleClick}
  style={{ backgroundColor: '#5249FF' }} // Add this line to set the background color to #5249FF
>
